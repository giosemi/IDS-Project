...
class _RegisterCardState extends ConsumerState<RegisterCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return AuthFormCard(
      ...
      title: 'Crea account',
      subtitle: 'Registrati su ArtID e inizia a costruire il tuo portfolio',
      child: Form(
        key: _formKey,
        child: Column(
            ...
            institutionsAsync.when(
              loading: () => const InputDecorator(
                decoration: InputDecoration(
                  labelText: 'Istituto AFAM di appartenenza',
              ...
              error: (_, _) => Column(
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    onPressed: () => ref.invalidate(afamInstitutionsProvider),
